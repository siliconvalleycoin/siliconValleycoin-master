// Copyright (c) 2014 The SiliconValley developers
...
void ShadowGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/shadow"), tr("&About SiliconValley"), this);
    aboutAction->setToolTip(tr("Show information about SiliconValley"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for SiliconValley"));
...
void ShadowGUI::createTrayIcon()
{
    ...
    trayIcon->setIcon(QIcon(":/icons/SiliconValley"));
...
void ShadowGUI::setNumConnections(int count)
{
    ...
    connectionsIcon.setAttribute("data-title", tr("%n active connection(s) to SiliconValley network", "", count));
}
...
void ShadowGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid SiliconValley address or malformed URI parameters."));
    }
