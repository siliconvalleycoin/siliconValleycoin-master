...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(uri.scheme() != QString("SiliconValley"))
        return false;
...
{
    // Convert SiliconValley:// to SiliconValley:
    //
    //    Cannot handle this later, because bitcoin:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("SiliconValley://"))
    {
        uri.replace(0, 12, "SiliconValley:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "SiliconValley.lnk";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    else
    {
        ...
        optionFile << "[Desktop Entry]\n" \
                   ...
                   << "MimeType=x-scheme-handler/SiliconValley;\n";
        optionFile.close();
    }
    return true;
}
