...
public:
    CBaseChainParams() {
        const char* pszTimestamp = "SiliconValley";
        CTransaction txNew;
        ...
        vSeeds.push_back(CDNSSeedData("SiliconValley.co1",  "160.19.48.83"));
        vSeeds.push_back(CDNSSeedData("SiliconValley.co1",  "43.248.101.57"));
        vSeeds.push_back(CDNSSeedData("SiliconValley.co1",  "103.79.121.45"));
...
public:
    CMainParams() {
        ...
        nLastFairLaunchBlock = 200;

        nFirstPosv2Block = 1000;
        nFirstPosv3Block = 10000;
        ...
        assert(hashGenesisBlock == uint256("0xfce296e82f0fde257c99c1b992cd24d34a6227ae2952fd5e8332e6cabc0a35c3"));
        assert(genesis.hashMerkleRoot == uint256("0x22ce1e6d64c4287b4c420e8956bd1859238066289f6f4726972ce47ebffef35c"));
...
public:
    CTestNetParams() {
      ...
      /*   LogPrintf("testnet.hashGenesisBlock == %s\n", hashGenesisBlock.ToString().c_str());
        ...
        assert(hashGenesisBlock == uint256("0x164bb3dae41ae7efcdd007232737d3ca83cff817896f12a2e2a222e62fc1c780"));
...
public:
    CRegTestParams() {
       ...
       /*  LogPrintf("regtest.hashGenesisBlock == %s\n", hashGenesisBlock.ToString().c_str());
        ...
        assert(hashGenesisBlock == uint256("0xae133dcef11c88dfa4035da6bed2bf1c9149a4e18fe0912f706869fe1de2f1f9"));
